...
{
    internal partial class HeadingControl : UserControl
    {
        public event Action<string> mapModeChange;
        Delegate[] buttonDelegate;
        private IWorkspaceManage workspaceManage;
        public HeadingControl(IWorkspaceManage workspaceManage)
        {
            InitializeComponent();
            SetWorkspaceManage(workspaceManage);
            initbtn();
        }
        /// <summary>
        /// 设置workspaceManage
        ...
        public void SetWorkspaceManage(IWorkspaceManage workspaceManage)
        {
